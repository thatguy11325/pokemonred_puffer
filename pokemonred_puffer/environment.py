    ...
    def agent_stats(self, action):
        ...
        return {
            "stats": {
                ...
                "met_bill": self.read_bit(0xD7F1, 0),
                "used_cell_separator_on_bill": self.read_bit(0xD7F2, 3),
                "ss_ticket": self.read_bit(0xD7F2, 4),
                "met_bill_2": self.read_bit(0xD7F2, 5),
                "bill_said_use_cell_separator": self.read_bit(0xD7F2, 6),
                "left_bills_house_after_helping": self.read_bit(0xD7F2, 7),
            },
